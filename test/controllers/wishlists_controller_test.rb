...
class WishlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wishlist" do
    assert_difference("Wishlist.count") do
      post wishlists_url, params: { wishlist: { content_id: @wishlist.content_id, user_id: @wishlist.user_id } }, as: :json
    end
  ...
  test "should update wishlist" do
    patch wishlist_url(@wishlist), params: { wishlist: { content_id: @wishlist.content_id, user_id: @wishlist.user_id } }, as: :json
    assert_response :success
  end
